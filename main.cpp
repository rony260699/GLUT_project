 ...
 * Rony Howlader
 * CSE 073 08276
 * Use upper key for day scene & lower key to night scene
 * Use mouse left button to speed up boat-1(forward) and right button for reverse speed
 */
...
///left sidewise border partition///
 //polygon 1
    ...
    glVertex2f(7.0f,3.0f);
    glVertex2f(6.0f,0.0f);
    glVertex2f(6.3f,-0.45f);
    glVertex2f(7.33f,3.0f);
...
void update1(int value) {
    ...
    if(moveA > 38)
    {
     ...
     // GLUT that the display has changed

//_moveA += 0.11;

    glutTimerFunc(20, update1, 0); // GLUT to call update again in 25 milliseconds
    glutPostRedisplay();
}
